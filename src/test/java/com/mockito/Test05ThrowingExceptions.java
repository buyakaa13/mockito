...
public class Test05ThrowingExceptions {
    ...
    @Test
    void should_ThrowException_When_NoBookAvailable() {
        RentingRequest rentingRequest = new RentingRequest("1", LocalDate.of(2025, Month.JANUARY, 1),
                LocalDate.of(2025, Month.JANUARY, 7), 2, false);
        when(this.bookServiceMock.findAvailableBookId(rentingRequest)).thenThrow(BusinessException.class);
